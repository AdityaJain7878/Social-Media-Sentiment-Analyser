...
This project uses the Sentiment140 dataset. The dataset is not included in this repository because it exceeds GitHub's file-size limit.

Download the dataset from Kaggle and place the following files inside the project data folder
